...
const AboutUs = () => {
  ...
  return (
    <section className="w-full h-auto p-2 lg:p-10 flex items-center justify-center flex-col text-center   ">
        ...
        <div>
          <div className=" lg:flex  justify-between  w-full h-auto  mt-10 gap-10 ">
                <h2 className="xl:w-[50%] w-full font-DMSans font-bold text-[18px] leading-[27px] xl:text-left xl:px-5 text-center ">At <span className="text-[#039AE4] font-DMSans font-bold text-[18px] leading-[27px] items-center ">OLAMAX EXCHANGE</span>, we are the place where people reach their goals with cryptocurrencies and blockchain technology. 
                We do that by offering a full scope of secure solutions to buy, sell, and earn digital assets. </h2>
                <p className="xl:w-[50%] w-full mt-10 xl:mt-0 font-Inter font-medium text-[14px] xl:text-left leading-[21px] xl:px-5 text-center ">Olamax.io is a product of Olamax associate  incorporated in Nigeria. We provide Cryptocurrency to Fiat exchange services for Bitcoin, Ethereum, Doge, Steem and Sbd to NAIRA. Our exchange provides you a marketplace
