    ...
    return (
      <div className=" mt-10 w-full h-auto ">
        <div className="text-left xl:text-center text-[#000000] ">
          <h2 className="font-Inter font-bold text-[18px] leading-[150%] xl:font-DMSans xl:text-[32px] xl:leading-[150%]">
            Our Values
          </h2>
          <p className="font-Inter font-medium text-[14px] leading-[150%] xl:text-[20px] xl:leading-[150%]">
        ...
        <div className="grid grid-cols-1  gap-5 xl:grid-cols-4 lg:grid-cols-4 mt-10">
          <div className="w-full h-auto bg-[#039AE4] rounded-[5px] xl:rounded-[20px]  text-[#ffffff] flex flex-col items-center justify-center py-6 px-5 ">
            ...
            <h2 className="text-center text-[14px] xl:text-[18px] font-bold font-Inter leading-[150%] xl:leading-[150%]  mb-2">Transparency</h2>
            <p className="text-center text-[12px] xl:text-[16px] font-Inter leading-[150%] font-normal xl:leading-[150%] p-3">
          ...
          <div className="w-full h-auto bg-[#121826] rounded-[5px]  xl:rounded-[20px] text-[#ffffff] flex flex-col items-center justify-center  py-6 px-5">
            <div className="size-8 bg-[#ffffff] flex items-center justify-center mb-3 rounded-full">
              <HeartHandshake className="size-6  text-[#121826] " />
            </div>
            <h2 className="text-center text-[14px] xl:text-[18px] font-bold font-Inter leading-[150%] xl:leading-[150%] mb-2 ">Security</h2>
            <p className="text-center text-[12px] xl:text-[16px] font-Interleading-[150%] font-normal xl:leading-[150%] p-3">
          ...
          <div className="w-full h-auto bg-[#039AE4] rounded-[5px]    xl:rounded-[20px] text-[#ffffff] flex flex-col items-center justify-center  py-2 px-3">
            ...
            <h2 className="text-center text-[14px] xl:text-[18px] font-bold font-Inter leading-[150%] xl:leading-[150%] mb-2">Innovation</h2>
            <p className="text-center text-[12px] xl:text-[16px] font-Inter leading-[150%] font-normal xl:leading-[150%] p-3">
            ...
            <h2 className="text-center text-[14px] xl:text-[18px] font-bold font-Inter leading-[150%] xl:leading-[150%] mb-2">Customer Focus</h2>
            <p className="text-center text-[12px] xl:text-[16px] font-Inter leading-[150%] font-normal xl:leading-[150%] p-3">
