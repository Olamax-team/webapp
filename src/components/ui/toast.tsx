...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title
    ref={ref}
    className={cn("md:text-base text-sm font-semibold [&+div]:text-xs", className)}
    {...props}
  />
))
