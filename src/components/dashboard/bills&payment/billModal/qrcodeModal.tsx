...
import { useActivePaymentModals} from '../../../../lib/utils'
import qrCode from '../../../../assets/images/QR.png'
import logo from '../../../../assets/images/GTCO.svg'
import { HiOutlineDuplicate } from 'react-icons/hi';
import { useActiveQRModals } from '../../../../lib/utils';

const QRModals = () => {
  const { isOpen, onClose } = useActiveQRModals();
const openPaymentModals = useActivePaymentModals();
    ...
    >
      <div className="flex flex-row gap-8">
        ...
        <div className='flex flex-col gap-5 w-[60%] justify-center items-center pb-9'>
          ...
          <div>
            <button className='font-poppins w-[250px] h-[54px] rounded-lg bg-primary hover:bg-secondary text-white mt-6' onClick={() => {onClose(); openPaymentModals.onOpen()}}>
              I Have Made Payment
            </button>
          </div>
        </div>
