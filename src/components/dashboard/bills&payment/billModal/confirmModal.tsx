...
const ConfirmModal = () => {
  ...
  const openActiveOTPModals = useOpenActiveOtpModals();
  return (
    <Modal 
      isOpen={isOpen} 
      onClose={onClose}
    ...
    >
      <div className='flex flex-col gap-10'>
        ...
        <div className="flex items-center justify-between gap-4">
          <button className='w-full h-12 rounded-lg bg-primary text-white' onClick={() => {openActiveOTPModals.onOpen(); onClose()}}>
            Yes
          </button>
