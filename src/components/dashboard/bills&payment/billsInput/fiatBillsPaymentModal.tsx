...
import { useFiatBillsPaymentModal, usePaymentConfirmationModal } from '../../../../lib/utils';
import { useApiConfig } from '../../../../hooks/api';
import useTradeStore from '../../../../stores/tradeStore';
import { useToast } from '../../../../hooks/use-toast';
import UploadModal from '../../../ui/upload-modal';

const FiatBillsPaymentModal = () => {
  const { isOpen, onClose } = useFiatBillsPaymentModal();
...
export default FiatBillsPaymentModal;
