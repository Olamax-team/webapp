  ...
  return (
    ...
    >
      <div className="flex items-center justify-center flex-col">
        <div
          className={`size-[35px] rounded-full flex items-center justify-center ${active === index ? 'bg-[#121826]/70' : 'bg-[#f8f9fA]'}`}
        >
          <Icon className={`size-6 ${active === index ? 'text-white' : 'text-[#121826]'}`} />
        </div>
        <p
          className={`text-[#121826] text-[10px] xl:text-[12px] leading-[14px] xl:leading-[18px] font-Inter text-center ${active === index ? 'text-white' : 'text-[#121826]'}`}
        >
          {name}
        </p>
      </div>
