  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row gap-8 w-full h-full">
        ...
        <div className={`bg-textDark text-white p-[42px] md:w-[40%] w-full transition-all duration-300 ${isMobile ? 'w-full h-full' : 'hidden md:block'}`}>
        ...
        <div className={`flex flex-col gap-5 md:w-[60%] w-full justify-center items-center pb-9 transition-all duration-300 ${isMobile ? 'hidden md:flex' : 'w-full'}`}>
