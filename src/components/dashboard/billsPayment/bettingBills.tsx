...
const BettingBills = ({setShowTransactionDetail}:bettingProps) => {
  ...
  const networkOptions = [
    { value: 'SportBet', logo: IBEDC },
    { value: 'Bet9ja', logo: IBEDC },
    { value: 'Bet9ja', logo: IBEDC },
    { value: 'Bet9ja', logo: IBEDC },
  ];
  ...
  return (
    <form onSubmit={handleBuyClick}>
            ...
            <div className="flex bg-[#f5f5f5] w-full xl:-h-[60px] h-[48px] rounded-sm mt-5">
              ...
              >
                <option value="FUND BETTING ACCOUNT" className="bg-white">Fund Betting Account</option>
