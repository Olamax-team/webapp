...
import { useChangePasswordModal, useVerifyPasswordChangeModal } from '../../lib/utils'
...
const VerifyPasswordChangeModal = () => {
  const { isOpen, onClose } = useVerifyPasswordChangeModal();
  ...
  return (
    ...
    >
      <div className='flex flex-col gap-10'>
        <div>
          <p className='text-sm lg:text-base'>We just have to make sure it&apos;s really you. Kindly Input the 6-digit code sent to your email.</p>
          <Form {...form}>
        ...
        <div>
          <button className='w-full h-12 rounded-lg bg-primary hover:bg-secondary text-white mt-6' onClick={() => {openChangePasswordModal.onOpen(); onClose()}}>
            Proceed
          </button>
