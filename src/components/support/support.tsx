  ...
  return (
    <section className="mx-auto my-auto w-full bg-bg overflow-hidden h-auto flex items-center justify-center flex-col">
        ...
        <div className="space-y-4 xl:space-y-8 px-20 xl:px-80 my-16 w-full flex flex-col items-center justify-center">
            <span>
                <h1 className="font-DMSans text-[32px] leading-[48px] font-bold">What can we help you with?</h1>
                <p className="font-Inter text-[20px] leading-[30px] font-medium">Need Help? Let's guide you.</p>
            </span>
        ...
        <div id="help" className="bg-primary bg-opacity-20 px-8 xl:px-20 items-center justify-center space-y-6 xl:space-y-16 py-16 font-Inter w-full">
            ...
            <div className="flex flex-row flex-wrap gap-4">
                {helpCat.map((help, index) => (
                    <div key={index} className=" bg-white rounded-lg w-full xl:w-[24%] px-7 py-10">
                        <div className="flex flex-col space-y-[18px] h-full">
                            ...
                            <span>
                                <h1 className="text-[18px] leading-[27px] font-bold">{help.label}</h1>
